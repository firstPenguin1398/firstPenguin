  ...
  return (
    <div>
      ...
      <p>
        ...
        <br/>
        코딩 스터디 또는 공모전, 멘토링 관련하여서도 기록하고 싶은 내용이 있다면 자유롭게 적어주세요.
      </p>
      ...
      <form>
        ...
        <input type="text"
          ...
          onChange={handleAddFormChange}
        /> */}
        <TextField id="outlined-basic" label="이름" variant="outlined" style={{paddingRight: "30px"}} />
        ...
        <TextField
          ...
          // defaultValue="작성해주세요"
        />
        <Button variant="outlined" fullWidth >입력 완료</Button>
        <br/><br/>
      </form>
      ...
      <Table>
        <TableHead>
          <TableRow>
            <TableCell style={{width: "100px", textAlign: "center"}}>이름</TableCell>
            <TableCell style={{width: "50px", textAlign: "center"}}>소속팀</TableCell>
            <TableCell style={{textAlign: "center"}}>오늘세션내용</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {members.map( m => {
            return <Member key={m.id} name={m.name} team={m.team} content={m.content} />
          })}
        </TableBody>
      </Table>
